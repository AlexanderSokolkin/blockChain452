...
contract Wallet {
    ...
    function sendWithoutOwnCommission(address dest, uint128 value, bool bounce) public pure checkOwnerAndAccept {
        dest.transfer(value, bounce, 0);
    }

    function sendWithOwnCommission(address dest, uint128 value, bool bounce) public pure checkOwnerAndAccept {
        dest.transfer(value, bounce, 1);
    }

    function sendAllMoneyAndDestroyWallet(address dest, bool bounce) public pure checkOwnerAndAccept {
